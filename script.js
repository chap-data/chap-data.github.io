...
var terrainLayer = L.tileLayer('https://server.arcgisonline.com/arcgis/rest/services/World_Physical_Map/MapServer/tile/{z}/{y}/{x}')
...
const imageBounds = [[53.6, 73.5], [3.799, 135.1]]; // 图片覆盖范围
...
function updateImageOverlay(dayhour) {
    ...
    if (selectType == "type-aqi") {
        ...
        imgUrl = `./PM2p5/data/webp/Y${dayhour.slice(0, 4)}/M${dayhour.slice(4, 6)}/D${dayhour.slice(6, 8)}/CHAP_NRT_PM2p5_${dayhour}00.webp`;
    } else if (selectType == "type-pm10") {
